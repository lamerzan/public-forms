...
MIDDLEWARE_CLASSES = (
    ...
    def test_package_importable(self):
        out = self.command('''python -c "from feincms.page.extensions import variative_renderer; print variative_renderer; print variative_renderer; print 333333;"''', output=True)
        out = '%s'%out
        self.assert_('feincms.page.extensions' in out)
        self.assert_('variative_renderer' in out)
        self.assert_('module' in out)
        self.assert_('333333' in out)

    def test_default_settings_importable(self):
        out = self.command('''python -c "from feincms.page.extensions.variative_renderer import settings; print settings; print 333333;"''', output=True)
        out = '%s'%out
        self.assert_('feincms.page.extensions' in out)
        self.assert_('variative_renderer' in out)
...
"""
    def setUp(self):
        ...
        self.models_path = resource_filename('feincms.page.extensions.variative_renderer', 'models.py')    
    ...
    def test_run_package_tests(self):
        with chdir(os.path.join(self.testdir, self.project_package_name)):
            self.command('python manage.py test variative_renderer')
...
"""
        ...
        models_path = resource_filename('feincms.page.extensions.variative_renderer', 'models.py')
    ...
    def test_register_warns_about_required_middlewares(self):
        ...
        from pkg_resources import resource_filename
        default_settings_path = resource_filename('feincms.page.extensions.variative_renderer',
                                                  'default_settings.py')
    ...
    def test_register_warns_about_required_apps(self):
        ...
        PROJECT_APP_SETTING_WITHOUT_REQUIRED = """\nINSTALLED_APPS = ['feincms.page.extensions.variative_renderer',]"""
