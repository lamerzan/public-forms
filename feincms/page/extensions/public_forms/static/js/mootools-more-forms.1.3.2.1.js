...
// Load this file's selection again by visiting: http://mootools.net/more/6413197b84d5bbfb56bf55cab48d2680 
// Or build this file again with packager using: packager build More/Element.Forms More/Form.Request More/Form.Request.Append More/Form.Validator More/Form.Validator.Inline More/Form.Validator.Extras
/*
---
copyrights:
...
}.bind(this)});this.attachReset();}});(function(){var b=function(c){return c!=null;};var a=Object.prototype.hasOwnProperty;Object.extend({getFromPath:function(e,f){if(typeof f=="string"){f=f.split(".");
